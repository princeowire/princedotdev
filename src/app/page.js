...
export default function Home() {
  const projectData = [
    ...
    {id: 3, title: "Blueice", description: "Project description: Built with semantic HTML5, custom CSS, and vanilla JavaScript. The site is fully responsive, features scroll-based navigation, and uses Flexbox for layout. Focused on performance, clean structure, and a mobile-first approach—without relying on frameworks or external libraries.", link: "https://euphoria-next-eight.vercel.app/", style: "basis-[60%] min-w-[250px]", details: "hello vbibvluib", src: blueice, },
    ...
    {id: 4, title: "Doug the poug (Replica)", description: "Project description", link: "https://bigdog-flame.vercel.app/", style: "basis-[25%] min-w-[250px]", details: "hello vbibvluib", src: bigDog, },
