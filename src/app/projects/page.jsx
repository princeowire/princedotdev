...
const projects = [
  ...
  { id: 3, tag: "WEB", title: "Onet", description: "Onet Sage is a modern, responsive educational platform built with Next.js and Tailwind CSS. Designed for aspiring developers and designers, it offers clear pathways to learn frontend, backend, and UI/UX skills. With an intuitive layout, engaging visuals, and smooth user experience, Onet Sage serves as a starting point for anyone entering the tech space. ", link: "https://onet-sage.vercel.app/", src: onet, stack: "JavaScript ReactJS Tailwind", github: "https://github.com/princeowire/onet" },
  ...
  { id: 7, tag: "WEB", title: "Jongi", description: "I Led the entire frontend development, from design to deployment. I focused on crafting a bold user interface, implementing smooth animation logic using JavaScript, and ensuring mobile-first responsiveness. The styling and component system were all built from scratch using Tailwind CSS, with attention to detail and consistency.", link: "https://princeowire.github.io/Jongi-media/", src: jongi, stack: "JavaScript Html CSS", github: "https://github.com/princeowire/Jongi-media" },
  { id: 8, tag: "WEB", title: "Jongi", description: "I Led the entire frontend development, from design to deployment. I focused on crafting a bold user interface, implementing smooth animation logic using JavaScript, and ensuring mobile-first responsiveness. The styling and component system were all built from scratch using Tailwind CSS, with attention to detail and consistency.", link: "https://princeowire.github.io/Jongi-media/", src: jongi, stack: "JavaScript Html CSS", github: "https://github.com/princeowire/Jongi-media" },
]
