      ...
      {({ isSubmitting }) => (
        <Form className="shadow-[0px_0px_05px_05px] border-amber-400 p-8 bg-[#1E1E1E] rounded-bl-2xl rounded-tr-2xl shadow-[#ffbb005a]">
          <div className="py-8 flex flex-wrap gap-y-16 w-full justify-between">
            <label className="basis-[43.5%] w-full">
              <p>First name:</p>
            ...
            <label className="basis-[43.5%] w-full">
              <p>Message:</p>
              <Field as="textarea" name="message" rows="4" className="border-b border-amber-400 w-full h-28 outline-0 bg-amber-200 text-black p-2.5" />
          ...
          <div className="pt-16 flex items-center justify-between">
            ...
            <div className="flex gap-4">
              <a href="https://linkedin.com/in/yourprofile" target="_blank"><CiLinkedin className="w-6 h-6" /></a>
              <a href="https://github.com/yourusername" target="_blank"><FaGithub className="w-6 h-6" /></a>
              <a href="https://twitter.com/yourhandle" target="_blank"><CiTwitter className="w-6 h-6" /></a>
