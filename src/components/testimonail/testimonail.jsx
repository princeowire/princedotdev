...
export default function TestimonialSwiper() {
  return (
    <div className="max-w-[1000px] w-full mx-auto max-sm:px-4 py-8">
      ...
      >
        {testimonials.map((testimonial) => (
          <SwiperSlide key={testimonial.id}>
            <div className="w-full max-w-[90%] sm:max-w-full mx-auto flex flex-col sm:flex-row items-center justify-center gap-6 sm:gap-10 bg-gray-800 p-6 sm:p-10 rounded-lg shadow-md">
