...
export default function TestimonialSwiper() {
  return (
    <div className="max-w-[1000px] w-full mx-auto max-lg:px-4 py-8">
      ...
      >
        {testimonials.map((testimonial) => (
          <SwiperSlide key={testimonial.id} className='w-full'>
            <div className="mx-auto min-h-[370px] h-full flex flex-col sm:flex-row items-center justify-center gap-6 sm:gap-10 bg-gray-800 p-6 sm:p-10 rounded-lg shadow-md">
